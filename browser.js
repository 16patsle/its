...
document.addEventListener('DOMContentLoaded', () => {
	...
	let messageObserver = new MutationObserver(messageBadgeCallback);
	messageObserver.observe(messageBadge, { childList: true });
	}
	...
	let notificationObserver = new MutationObserver(notificationBadgeCallback);
	notificationObserver.observe(notificationBadge, { childList: true });
	}
});
